...
$pages = [
    'Home' => "# Welcome to LiteWiki

<div class='text-center margin-y-2'>
<h1 class='h1-large'>LiteWiki</h1>
<p class='subtitle'>The free wiki framework that anyone can edit</p>
<p class='subtitle-small'>1,234 articles in English</p>
</div>

<div class='promo-box'>
<h2 class='promo-title'>Create your first article</h2>
<p class='promo-subtitle'>Start building knowledge by creating a new page</p>
<a href='/?action=create' class='promo-button'>Create new page</a>
</div>
...
<a href='/?action=edit&page=Getting+Started' class='btn-secondary-inline'>Edit this page</a>
</div>
</div>
<div class='card'>
<h3 class='card-subtitle'>Did you know...</h3>
<ul class='list-custom'>
<li class='margin-bottom-half'>LiteWiki supports over 100 programming languages for syntax highlighting</li>
<li class='margin-bottom-half'>The search feature includes advanced filtering by author and date</li>
<li class='margin-bottom-half'>All content is stored in a lightweight SQLite database</li>
</ul>
</div>
</div>
...
<h2 class='card-title-large'>Recent changes</h2>
<div class='grid-4'>

<div class='highlight-primary'>
<h4 class='item-title'><a href='/?action=view&page=Getting+Started' class='link-primary-no-underline'>Getting Started</a></h4>
<p class='item-text'>Updated installation instructions and added new screenshots</p>
<div class='item-meta'>2 hours ago by admin</div>
</div>

<div class='highlight-success'>
<h4 class='item-title'><a href='/?action=view&page=Markdown+Guide' class='link-primary-no-underline'>Markdown Guide</a></h4>
<p class='item-text'>Added section on Mermaid diagram syntax</p>
<div class='item-meta'>5 hours ago by admin</div>
</div>

<div class='highlight-warning'>
<h4 class='item-title'><a href='/?action=view&page=API+Documentation' class='link-primary-no-underline'>API Documentation</a></h4>
<p class='item-text'>Updated authentication examples for Python</p>
<div class='item-meta'>1 day ago by admin</div>
</div>

</div>
<a href='/?action=list' class='link-primary-block'>View all recent changes →</a>
</div>

<div class='footer-section'>
<p class='footer-text'>LiteWiki is a free wiki framework built with PHP and SQLite</p>
<div class='footer-links'>
<a href='/?action=view&page=System+Architecture' class='link-light'>About LiteWiki</a>
<a href='/?action=view&page=Markdown+Guide' class='link-light'>Help</a>
<a href='/?action=view&page=API+Documentation' class='link-light'>Developers</a>
...
foreach ($pages as $title => $content) {
    ...
    if ($result['success']) {
        ...
        if ($result['success']) {
            ...
            echo "❌ Failed to create/update page: $title - " . $result['message'] . "\n";
            $errors++;
        }
    }
}
